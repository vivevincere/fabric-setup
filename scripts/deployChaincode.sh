...
chaincodeInvoke() {
    ...
    peer chaincode invoke -o localhost:7050 \
        ...
        -C $CHANNEL_NAME -n ${CC_NAME} \
        --peerAddresses localhost:7051 --tlsRootCertFiles $PEER0_ORG1_CA \
        -c '{"function": "LogEvent","Args":["faucet","1234", "68656c6c6f2075206c6974746c65207368697473"]}' 
}
...
chaincodeQuery() {
    ...
    peer chaincode query -C $CHANNEL_NAME -n ${CC_NAME} -c '{"function": "QueryEvent","Args":["faucet", "1234" ]}'
}
